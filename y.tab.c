...
static const char *const yytname[] =
{
  ...
  "VEZES", "COLCHETE", "MULTIPLY", "SOMA", "$accept", "PROGRAMA",
...
#line 28 "./src/imageprocessing.y" /* yacc.c:1646  */
    {
        ...
        brilho(&I, (yyvsp[-1].ival), (yyvsp[0].fval));
...
#line 48 "./src/imageprocessing.y" /* yacc.c:1906  */
